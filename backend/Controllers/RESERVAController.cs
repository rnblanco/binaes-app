...
namespace backend.Controllers
{
    ...
    public class RESERVAController : ApiController
    {
        ...
        // GET: api/RESERVA?limit=5&page=1&search=test&sortby=col:ASC&id_rolUsuario&id_Usuario
        public async Task<IHttpActionResult> GetRESERVA(int limit, int page, string search, string SortBy, int id_rolUsuario, string id_Usuario)
        {
            ...
            List<RESERVA> bookings = new List<RESERVA>();
